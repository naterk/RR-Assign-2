...
```{r UncompressAndReadData, echo=TRUE, cache=TRUE}
##
...
```{r ConvertDamageEstimates, echo=TRUE}
##
...
```{r ExtractCompleteCases, ech=TRUE}
##
...
An additional `r formatC(src.obs - cln.obs, format="d", big.mark=",")` observations were deleted.  This is the last processing step.
